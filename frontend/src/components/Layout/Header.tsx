...
export function Header({ activeTab, onTabChange }: HeaderProps) {
  const tabs = [
    { id: "editor", label: "Editor", icon: "M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z" },
    ...
    { id: "outputs", label: "Outputs", icon: "M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" },
  ...
  return (
    <header className="h-14 bg-surface border-b border-border px-4 flex items-center justify-between">
      ...
      {/* Tabs */}
      <nav className="flex items-center gap-1 bg-surface-deep rounded-lg p-1">
        {tabs.map((tab) => (
          <button
            key={tab.id}
